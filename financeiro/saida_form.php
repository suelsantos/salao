...
$categoria = $global->getCategoriaPgt(null, 2);
$conta = $global->getContaBancaria();

$saida = new Saida();
//$cidadaoClass = new Cidadao();
//
//$cidadao = $cidadaoClass->getCidadao("id_unidade", $_SESSION['id_unidade'], null, 1);

$id_saida = $_REQUEST['saida'];
$tipo_saida = $_REQUEST['_tipo'];

//AÇÔES
if(isset($_REQUEST['save'])){
    $saida->cadSaida();
    $tipo_saida = $saida->tipo;
}elseif(isset($_REQUEST['refresh'])){
    $saida->editSaida($id_saida);
    $id_saida = $saida->cod;
}

$qry = $saida->getSaida("id_saida", $id_saida);
...
<!--<![endif]-->
	...
	<div id="page-loader" class="fade in"><span class="spinner"></span></div>
        ...
        <form action="" method="post" name="form1" class="form-horizontal" id="form1" data-parsley-validate="true" enctype="multipart/form-data">            
            <input type="hidden" name="saida" value="<?php echo $id_saida; ?>" />
            <input type="hidden" name="_tipo" id="_tipo" value="<?php echo $tipo_saida; ?>" />
            ...
            <div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-light-sidebar">                                
                ...
                <div id="content" class="content">                    
                    <ol class="breadcrumb pull-right m-b-15">
                        <li><a href="saida_list.php">Saidas</a></li>
                                    ...
                                    <div class="row m-r-10 m-l-10">                                                                                                                                                                                                        
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-1 control-label">Data Vencimento</label>
                                                <div class="col-md-5">
                                                    <div class="input-group date" id="datepicker-disabled-past" data-date-format="dd-mm-yyyy" data-date-start-date="Date.default">
                                                        <input type="text" class="form-control input-lg date_picker mask_data" name="cadastro[data_vencimento]" id="data_vencimento" data-parsley-required="true" data-parsley-type="databr" value="<?php echo ($row['data_vencimento'] != 0) ? converteData($row['data_vencimento'], "d/m/Y") : ""; ?>">

    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "minSize": {
                    "regex": "none",
                    "alertText": "* Permitido o mánimo de ",
                ...
                "creditCard": {
                    "regex": "none",
                    "alertText": "* Námero de cartão de crédito inválido"
                },
                "phone": {
                ...
                "arquivoPonto":{
                    "regex": /(\\|^)(\d{8})(0[1-9]|[1,2][0-9]|3[0,1])(0[1-9]|1[0,1,2])\d{4}(0[0-9]|1[0-9]|2[0-3])([0-5][0-9])([0-5][0-9])\.txt$/,
                    "alertText":"O Arquivo nao segue o padrao exigido"
                },
                "arquivoTxt":{
                    "regex": /^.+\.(doc|docx|rtf|pdf)$/,
                    "alertText":"O Arquivo nao segue o padrao exigido"
                }
            };

...
<div id="img_perfil">
    ...
    <button type="submit" class="btn btn-info pull-right m-t-15" id="save_foto" name="save_foto" data-key="<?php echo $id_usuario; ?>"><span class="fa fa-save"></span>&nbsp;&nbsp;Salvar</button>
